...
//         {
//             (Node as SwitchNode).Nodes.ForEach(node => AddElement(node.Out, node.Condition));
//         }
//         public override void Save()
//         {
//             (Node as SwitchNode).Nodes = _nodes.Select(n => new SwitchNode.Option() { Condition = n.Item1.Value, Out = n.Item2.connected ? (n.Item2.connections.First()?.input.node as PlayableTrackNodeView).Node : null }).ToList();
//         }
//     }
// }