...
{
    [Serializable]
    public struct AndNode : IBoolNode
    {
        ...
        public readonly int Precedence => 2;
        public override readonly string ToString() => $"{NodeUtils.ToStringWithParens(this, LNode)} and {NodeUtils.ToStringWithParens(this, RNode)}";
