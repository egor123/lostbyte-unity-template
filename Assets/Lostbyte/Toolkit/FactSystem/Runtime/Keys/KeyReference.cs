...
namespace Lostbyte.Toolkit.FactSystem
{
    ...
    public class KeyReference : MonoBehaviour, IKeyContainer
    {
        ...
        public void Subscribe(FactDefinition fact, Action callback) => Key.Subscribe(fact, callback);
        ...
        public void Unsubscribe(FactDefinition fact, Action callback) => Key.Unsubscribe(fact, callback);
